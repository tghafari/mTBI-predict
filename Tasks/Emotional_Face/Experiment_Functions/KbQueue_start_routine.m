...
cfgExp.AstonNottKeyM = KbName('1!');  % AU and UoN button box responses for male #TO BE CHECKED
cfgExp.AstonNottKeyF = KbName('5%');  % AU and UoN button box responses for female #TO BE CHECKED
