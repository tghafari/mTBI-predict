...
cfgTrigger = struct(cuesRL, cfgCue.cueRndIdx + 100);  % 101 -> cue right, 102 -> cue left
cfgTrigger.cuesRL(:,1) = num2str(cfgCue.cueRndIdx);
cfgTrigger.cuesRL(find(cfgCue.cueRndIdx == 1), 2) = {'Right'};  % trigger message for Eyelink
cfgTrigger.cuesRL(find(cfgCue.cueRndIdx == 2), 2) = {'Left'};  
