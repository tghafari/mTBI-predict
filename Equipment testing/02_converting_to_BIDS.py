...
from mne_bids import (BIDSPath, write_raw_bids, write_meg_calibration,
                      write_meg_crosstalk, write_anat, anonymize_dataset)
...
for task in tasks:
    ...
    bids_root = r'Z:\MEG_data\MNE-bids-data'
    bids_root_anon = r'Z:\MEG_data\MNE-bids-data-anonymized'
    ...
    if task == 'SpAtt':
        ...
        other_events = {'trial start': 1, 'trial end':2, 
                        'cue onset right':101, 'cue onset left':102, 'cue offset':103,
                         'catch trial':104, 'stim onset':201, 'stim offset':202,
                         'dot onset right':211, 'dot onset left':212, 'dot offset':213,
                         'response press onset':255, 'block end':14,
        ...
        other_events = {'trial start': 1, 'trial end':2,
                        'cue onset right':101, 'cue onset left':102, 'cue offset':103,
                        'catch trial':104, 'response right onset':254, 'response left onset':255, 
...
# Run anonymization on the whole dataset
