function cfgOutput = dispCue(window, presentingStr, nstim, cfgScreen, cfgExp, cfgTrigger, cfgOutput)
% dispFixDot(window, cfgScreen, cfgExp, cfgTrigger, cfgExp, cfgOutput)
