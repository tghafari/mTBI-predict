function cfgOutput = display_visual_stim(window, presentingStr, nstim, cfgScreen, cfgExp, cfgOutput, cfgStim, cfgTrigger)
...
if cfgExp.corrResp(nstim)
    ...
    for frm = 1:cfgExp.stimFrm(nstim)
        Screen('DrawTextures', window, [presentingStr.visStimR{nstim}, presentingStr.visStimL{nstim}]...
            , [], [cfgScreen.destVisStimR', cfgScreen.destVisStimL'],[cfgScreen.stimAngleR{nstim}(frm), cfgScreen.stimAngleL{nstim}(frm)]);
