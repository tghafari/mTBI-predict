...
cfgScreen.destRectH = 7;  % height of big destination rectangle for stimulus in visual degrees
cfgScreen.destRectW = 7;  % width of big destination rectangle for stimulus in visual degrees
