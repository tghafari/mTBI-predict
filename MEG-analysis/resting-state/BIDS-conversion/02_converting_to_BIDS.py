...
# fill these out
site = 'Birmingham'
subj_code = 'b39d'  # subject code generated by participant/MEG pc (without the date part)
subject = '2012'  # subject code in mTBI project (can be found from the name of the fif file)
...
day = '05'  # date of data collection -> removed after anonymization
month = '12'
year = '2023'
