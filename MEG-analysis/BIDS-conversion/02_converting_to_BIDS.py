...
# fill these out
site = 'Birmingham'
subj_code = 'b36d'  # subject code generated by participant/MEG pc (without the date part)
subject = '2001'  # subject code in mTBI project (can be found from the name of the fif file)
session = '02B'  # data collection session within each run (can be found from the name of the fif file)
run = '01'  # data collection run for each participant (can be found from the name of the fif file)
pilot = 'T' # is the data collected 'P'ilot or 'T'ask 
day = '19'  # date of data collection -> removed after anonymization
month = '06'
year = '2023'
MRI_convert = False  # do you also want to convert MRI for this participant?

data_root = r'Z:\Projects\mTBI_predict\Collected_Data'
MEG_data_folder = op.join(data_root, 'MEG_data\Raw-real_participants')  # RDS/storage folder for MEG data
...
for t, task in enumerate(tasks):
    ...
    for r, run in enumerate(runs):
        ...
        bids_root = op.join(data_root, 'BIDS')
