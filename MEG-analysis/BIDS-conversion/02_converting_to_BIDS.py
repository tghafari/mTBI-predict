...
# fill these out
site = 'Birmingham'
subj_code = 'b3a0'  # subject code generated by participant/MEG pc (without the date part)
subject = '2010'  # subject code in mTBI project (can be found from the name of the fif file)
session = '05B'  # data collection session within each run (can be found from the name of the fif file)
day = '29'  # date of data collection -> removed after anonymization
month = '11'
year = '2023'
...
BIDS_tasks = ['CRT', 'rest', 'EmoFace', 'SpAtt', 'noise']  # task names after BIDS conversion - this is used if tasks
