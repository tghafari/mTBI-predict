...
bids_path = BIDSPath(subject=session_info.subject, session=session_info.session, datatype ='meg',
                     suffix=meg_suffix, extension=meg_extension, task=session_info.task, run=session_info.run, root=bids_root)
